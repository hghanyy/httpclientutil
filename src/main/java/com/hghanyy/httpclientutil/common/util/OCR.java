package com.hghanyy.httpclientutil.common.util;
...
import com.hghanyy.httpclientutil.HttpClientUtil;
import com.hghanyy.httpclientutil.builder.HCB;
import com.hghanyy.httpclientutil.common.HttpConfig;
import com.hghanyy.httpclientutil.common.HttpHeader;
import com.hghanyy.httpclientutil.common.Utils;
import com.hghanyy.httpclientutil.exception.HttpProcessException;
...
public class OCR {
    ...
    private static final String apiKey ="1a8085d1b4e993649f2SvMv6S33ZzHfUb7OTVlT048KA9t0GcT1fSaumUsi9UYSb6kX6t3IlnbA";// PropertiesUtil.getProperty("OCR.key");
